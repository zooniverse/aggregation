...
if not(os.path.isfile("/home/greg/Databases/penguins/images/"+fName)):
    #urllib.urlretrieve ("http://demo.zooniverse.org/penguins/subjects/standard/"+fName, "/home/greg/Databases/penguins/images/"+fName)
    urllib.urlretrieve ("http://www.penguinwatch.org/subjects/standard/"+fName, "/home/greg/Databases/penguins/images/"+fName)

print "/home/greg/Databases/penguins/images/"+fName
image_file = cbook.get_sample_data("/home/greg/Databases/penguins/images/"+fName)
